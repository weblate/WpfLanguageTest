...
namespace WpfLanguageTest.I18n
{
    public class I18nService : II18nService
    {
        ...
        private string customLanguagesDirectory = System.IO.Path.Combine(ApplicationPaths.ExecutionFolder, ApplicationPaths.CustomLanguagesFolder);
        ...
        private void LoadLanguages()
        {
            ...
            foreach (string builtinLanguageFile in builtinLanguageFiles)
            {
                ...
                if (builtinlanguage != null)
                {
                    ...
                    if (builtinlanguage.Code.ToUpper().Equals("EN"))
                    {
